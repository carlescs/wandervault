...
fun DocumentInfoScreen(
    ...
    DocumentInfoContent(
        ...
        onAnalyzeFlightAddLegConfirmed = viewModel::onFlightAddLegConfirmed,
        ...
        onAnalyzeActivityDestinationSelected = viewModel::onActivityDestinationSelected,
        onAnalyzeActivityConfirmed = viewModel::onActivityConfirmed,
...
internal fun DocumentInfoContent(
    ...
    onAnalyzeFlightAddLegConfirmed: () -> Unit = {},
    onAnalyzeHotelDestinationSelected: (Destination) -> Unit = {},
    onAnalyzeHotelConfirmed: () -> Unit = {},
    onAnalyzeTripInfoConfirmed: () -> Unit = {},
    onAnalyzeActivityDestinationSelected: (Destination) -> Unit = {},
    onAnalyzeActivityConfirmed: () -> Unit = {},
    ...
    if (analyzeState != null && !analyzeState.isInProgress) {
        AnalyzeDocumentDialog(
            ...
            onFlightAddLegConfirmed = onAnalyzeFlightAddLegConfirmed,
            ...
            onActivityDestinationSelected = onAnalyzeActivityDestinationSelected,
            onActivityConfirmed = onAnalyzeActivityConfirmed,
