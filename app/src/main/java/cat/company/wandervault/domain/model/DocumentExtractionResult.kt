 ...
 *   references) when the document contains no structured flight or hotel lines.
 *   `null` if nothing relevant was found or if [flightInfoList] or [hotelInfoList] is non-empty.
