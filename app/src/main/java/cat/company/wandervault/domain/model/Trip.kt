 ...
 * @param aiDescriptionSourceDocumentId The ID of the [TripDocument] from which [aiDescription]
 *   was extracted, or `null` when it was generated by on-device AI or not set.
 */
data class Trip(
    val id: Int,
    val title: String,
    ...
    val aiDescriptionSourceDocumentId: Int? = null,
)
